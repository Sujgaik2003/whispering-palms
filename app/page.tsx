  ...
  return (
    <main className="min-h-screen relative overflow-hidden bg-gradient-soft">
      ...
      <nav className="sticky top-0 z-50 w-full bg-gradient-to-br from-gold-50/95 via-ivory-100/95 to-gold-50/95 backdrop-blur-lg border-b border-gold-200/30 shadow-soft">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-3 sm:py-4 md:py-5">
          <div className="flex items-center justify-between gap-2 sm:gap-3">
            {/* Logo */}
            <Link href="/" className="flex items-center gap-2 sm:gap-3 hover:opacity-80 transition-opacity duration-300 flex-shrink-0">
              <div className="p-1.5 sm:p-2 bg-gradient-to-br from-gold-400 to-gold-600 rounded-xl shadow-soft">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 11.5V14m0-2.5v-6a1.5 1.5 0 113 0m-3 6a1.5 1.5 0 00-3 0v2a7.5 7.5 0 0015 0v-5a1.5 1.5 0 00-3 0m-6-3V11m0-5.5v-1a1.5 1.5 0 013 0v1m0 0V11m0-5.5a1.5 1.5 0 013 0v3m0 0V11" />
                </svg>
              </div>
              <span className="text-lg sm:text-xl md:text-2xl font-bold text-text-primary whitespace-nowrap">{t('dashboard.title')}</span>
            </Link>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <Link
                href="/login"
                className="px-3 sm:px-4 md:px-5 py-2 sm:py-2.5 bg-white/90 backdrop-blur-sm border-2 border-gold-400/50 text-text-primary rounded-lg sm:rounded-xl font-semibold text-xs sm:text-sm md:text-base tracking-wide transition-all duration-300 hover:bg-white hover:border-gold-500 hover:shadow-soft hover:scale-105 whitespace-nowrap"
              >
                {t('auth.signInLink')}
              </Link>
              <Link
                href="/register"
                className="group relative px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 bg-gradient-to-r from-gold-500 to-gold-600 text-white rounded-lg sm:rounded-xl font-semibold text-xs sm:text-sm md:text-base tracking-wide transition-all duration-300 hover:scale-110 hover:shadow-soft-lg overflow-hidden whitespace-nowrap"
              >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-8 sm:py-12 md:py-20">
        ...
        <footer className={`mt-16 sm:mt-24 md:mt-32 pt-6 sm:pt-8 border-t border-beige-300/50 transition-all duration-700 delay-1500 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-6 text-xs sm:text-sm text-text-tertiary px-2">
