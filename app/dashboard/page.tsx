  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gold-50 via-ivory-100 to-gold-50 p-4 md:p-6">
      <div className="max-w-7xl mx-auto py-6">
        {/* Header */}
        <div className={`bg-gradient-to-br from-gold-50/90 via-ivory-100/90 to-gold-50/90 backdrop-blur-lg rounded-3xl p-6 md:p-8 shadow-soft-xl border border-gold-200/50 mb-6 transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex items-center gap-4">
              <div className="p-3 bg-gradient-to-br from-gold-400 to-gold-600 rounded-2xl shadow-soft animate-pulse-soft hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                </svg>
              </div>
              <div key={`welcome-${language}-${renderKey}`}>
                <h1 className="text-3xl md:text-4xl font-bold text-text-primary mb-1">{t('dashboard.title')}</h1>
                <p className="text-text-secondary text-sm md:text-base">{t('common.welcome')}, <span className="text-gold-600 font-semibold">{user?.name || user?.email}</span>!</p>
                {profileCompletion > 0 && (
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-5 py-2.5 bg-red-500 hover:bg-red-600 text-white rounded-xl font-semibold transition-all shadow-soft hover:shadow-soft-lg flex items-center gap-2"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className={`bg-gradient-to-br from-gold-50/90 via-ivory-100/90 to-gold-50/90 backdrop-blur-lg rounded-3xl p-6 md:p-8 shadow-soft-xl border border-gold-200/50 transition-all duration-700 delay-100 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          {/* Action Cards - 2 per row layout */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            <Link
              href="/settings"
              className={`group relative block p-8 min-h-[180px] bg-gradient-to-br from-peach-50 via-peach-100 to-peach-50 hover:from-peach-100 hover:via-peach-200 hover:to-peach-100 rounded-3xl border-2 border-peach-300 hover:border-peach-500 transition-all duration-700 shadow-soft-xl hover:shadow-[0_20px_60px_rgba(255,157,122,0.4)] hover:-translate-y-2 hover:scale-[1.01] overflow-hidden ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            ...
            >
              ...
              <div className="relative z-10 flex items-center justify-between">
                <div className="flex items-center gap-6 flex-1">
                  <div className="p-5 bg-gradient-to-br from-peach-500 to-peach-600 rounded-2xl group-hover:scale-125 group-hover:rotate-12 transition-all duration-700 shadow-soft-xl animate-pulse-soft group-hover:shadow-[0_10px_40px_rgba(255,157,122,0.6)]">
                    <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                  </div>
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-text-primary mb-2 group-hover:text-peach-700 transition-colors duration-300">{t('dashboard.completeProfile')}</h3>
                    <p className="text-text-secondary text-base leading-relaxed">{t('dashboard.completeProfileDesc')}</p>
                  </div>
                </div>
                <div className="flex items-center text-peach-600 text-base font-bold group-hover:text-peach-700 transition-colors duration-300">
            ...
            <Link
              ...
              className={`group relative block p-8 min-h-[180px] bg-gradient-to-br from-sage-50 via-sage-100 to-sage-50 hover:from-sage-100 hover:via-sage-200 hover:to-sage-100 rounded-3xl border-2 border-sage-300 hover:border-sage-500 transition-all duration-700 shadow-soft-xl hover:shadow-[0_20px_60px_rgba(143,165,122,0.4)] hover:-translate-y-2 hover:scale-[1.01] overflow-hidden ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            ...
            >
              ...
              <div className="relative z-10 flex items-center justify-between">
                <div className="flex items-center gap-6 flex-1">
                  <div className="p-5 bg-gradient-to-br from-sage-500 to-sage-600 rounded-2xl group-hover:scale-125 group-hover:rotate-12 transition-all duration-700 shadow-soft-xl animate-pulse-soft group-hover:shadow-[0_10px_40px_rgba(143,165,122,0.6)]">
                    <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-text-primary mb-2 group-hover:text-sage-700 transition-colors duration-300">{t('dashboard.uploadPalms')}</h3>
                    <p className="text-text-secondary text-base leading-relaxed">{t('dashboard.uploadPalmsDesc')}</p>
                  </div>
                </div>
                <div className="flex items-center text-sage-600 text-base font-bold group-hover:text-sage-700 transition-colors duration-300">
                  <span>{t('common.uploadNow')}</span>
                  <svg className="w-5 h-5 ml-3 group-hover:translate-x-2 transition-transform duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                  </svg>
                </div>
            ...
            <Link
              href="/chat"
              className={`group relative block p-8 min-h-[180px] bg-gradient-to-br from-gold-50 via-gold-100 to-gold-50 hover:from-gold-100 hover:via-gold-200 hover:to-gold-100 rounded-3xl border-2 border-gold-300 hover:border-gold-500 transition-all duration-700 shadow-soft-xl hover:shadow-[0_20px_60px_rgba(230,194,89,0.4)] hover:-translate-y-2 hover:scale-[1.01] overflow-hidden ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            ...
            >
              ...
              <div className="relative z-10 flex items-center justify-between">
                <div className="flex items-center gap-6 flex-1">
                  <div className="p-5 bg-gradient-to-br from-gold-500 to-gold-600 rounded-2xl group-hover:scale-125 group-hover:rotate-12 transition-all duration-700 shadow-soft-xl animate-pulse-soft group-hover:shadow-[0_10px_40px_rgba(230,194,89,0.6)]">
                    <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                    </svg>
                  </div>
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-text-primary mb-2 group-hover:text-gold-700 transition-colors duration-300">{t('dashboard.askQuestions')}</h3>
                    <p className="text-text-secondary text-base leading-relaxed">{t('dashboard.askQuestionsDesc')}</p>
                  </div>
                </div>
                <div className="flex items-center text-gold-600 text-base font-bold group-hover:text-gold-700 transition-colors duration-300">
                  <span>{t('common.askNow')}</span>
                  <svg className="w-5 h-5 ml-3 group-hover:translate-x-2 transition-transform duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                  </svg>
                </div>
            ...
            <Link
              href="/subscription"
              className={`group relative block p-8 min-h-[180px] bg-gradient-to-br from-purple-50 via-purple-100 to-purple-50 hover:from-purple-100 hover:via-purple-200 hover:to-purple-100 rounded-3xl border-2 border-purple-300 hover:border-purple-500 transition-all duration-700 shadow-soft-xl hover:shadow-[0_20px_60px_rgba(147,51,234,0.4)] hover:-translate-y-2 hover:scale-[1.01] overflow-hidden ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            ...
            >
              ...
              <div className="relative z-10 flex items-center justify-between">
                <div className="flex items-center gap-6 flex-1">
                  <div className="p-5 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl group-hover:scale-125 group-hover:rotate-12 transition-all duration-700 shadow-soft-xl animate-pulse-soft group-hover:shadow-[0_10px_40px_rgba(147,51,234,0.6)]">
                    <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                    </svg>
                  </div>
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-text-primary mb-2 group-hover:text-purple-700 transition-colors duration-300">{t('dashboard.subscriptionPlans')}</h3>
                    <p className="text-text-secondary text-base leading-relaxed">{t('common.upgradeFeatures')}</p>
                  </div>
                </div>
                <div className="flex items-center text-purple-600 text-base font-bold group-hover:text-purple-700 transition-colors duration-300">
                  <span>{t('dashboard.viewPlans')}</span>
                  <svg className="w-5 h-5 ml-3 group-hover:translate-x-2 transition-transform duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                  </svg>
                </div>
                ...
                <div className="relative z-10 flex flex-col">
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-5">
                      <div className="p-4 bg-gradient-to-br from-gold-500 to-gold-600 rounded-2xl shadow-soft-xl animate-pulse-soft group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 group-hover:shadow-[0_15px_50px_rgba(230,194,89,0.5)]">
                        <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                        </svg>
                      </div>
                      <div>
                        <h3 className="text-xl font-bold text-text-primary mb-1">{t('common.dailyQuota')}</h3>
                        <p className="text-text-secondary text-sm">{t('common.resetsAt')} {new Date(quota.resetAt).toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit' })}</p>
                      </div>
                    </div>
                    <div className="text-right">
                      {quota.max === -1 ? (
                        <>
                          <div className="text-4xl font-bold text-purple-600 transition-all duration-500">
                            <span className="inline-block animate-scale-in">∞</span>
                          </div>
                          <div className="text-text-secondary text-sm font-medium mt-1">{t('common.unlimited')}</div>
                        </>
                      ) : (
                        <>
                          <div className={`text-4xl font-bold transition-all duration-500 ${quota.remaining === 0
                            ? 'text-red-600'
                            : quota.remaining <= 1
                              ? 'text-yellow-600'
                              : 'text-green-700'
                          ...
                          <div className="text-text-secondary text-sm font-medium mt-1">{t('common.remaining')}</div>
                        </>
                      )}
                    </div>
                  </div>
